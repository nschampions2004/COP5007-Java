...
public class GolferTest 
{
   public static void main (String[] args)
   {
     ...
     System.out.println(balla1.getScoreVal() + " \t " + balla1.getCourseName() + " \t " + balla1.getDate() + " \t " + balla1.getCourseRating() + " \t " + balla1.getCourseSlope() + " \n ");
     ...
     System.out.println(rappa.toString());
